...
class UserServiceClient extends $grpc.Client {
  ...
  $grpc.ResponseFuture<$0.Empty> signup($2.SignupRequest request,
...
abstract class UserServiceBase extends $grpc.Service {
  ...
  UserServiceBase() {
    $addMethod($grpc.ServiceMethod<$2.SignupRequest, $0.Empty>(
        'Signup',
        signup_Pre,
        false,
        false,
        ...
        ($0.Empty value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$0.Empty, $2.GetCurrentUserResponse>(
        'GetCurrentUser',
        getCurrentUser_Pre,
        false,
        false,
